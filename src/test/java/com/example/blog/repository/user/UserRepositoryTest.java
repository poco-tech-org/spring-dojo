...
class UserRepositoryTest {
    ...
    @Sql(statements = {
            "INSERT INTO users (id, username, password, enabled, image_path) VALUES (999, 'test_user_1', 'test_user_1_pass', true, 'test_user_1_image_path');",
            "INSERT INTO users (id, username, password, enabled, image_path) VALUES (998, 'test_user_2', 'test_user_2_pass', true, 'test_user_2_image_path');"
    })
    void selectByUsername_success() {
        ...
        assertThat(actual).hasValueSatisfying(actualEntity -> {
            ...
            assertThat(actualEntity.getImagePath()).isEqualTo("test_user_1_image_path");
        });
    }
    ...
    void update_success() {
        // ## Arrange ##
        var existingUser1 = new UserEntity(1L, "user_1", "password_1", true, "image_path_1");
        var existingUser2 = new UserEntity(2L, "user_2", "password_2", true, "image_path_2");
